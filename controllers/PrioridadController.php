...
class PrioridadController extends Controller
{
     ...
     * @param int $prio_id Prio ID
     * @return string
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionView($prio_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($prio_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'prio_id' => $model->prio_id]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($prio_id)
    {
        $model = $this->findModel($prio_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($prio_id)
    {
        $this->findModel($prio_id)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($prio_id)
    {
        if (($model = Prioridad::findOne(['prio_id' => $prio_id])) !== null) {
            return $model;
        }
